          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="<?php echo base_url();?>index.php/category/add"><i class="fa fa-circle-o"></i> 添加分类</a></li>
        ...
        <section class="content">
                <div class="form-horizontal" role="form">
                   <div class="form-group">
                      ...
                      <div class="col-sm-4">
                         <input type="text" class="form-control" id="category_cn" 
                            placeholder="分类名">
                      </div>
                   </div>
                   <div class="form-group">
                   ...
                   <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                         <button type="submit" id="add_category" class="btn btn-default">添加</button>
                      </div>
                   </div>
            </div>
