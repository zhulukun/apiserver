          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo base_url();?>index.php/user/analysis"><i class="fa fa-circle-o"></i> 用户分析</a></li>
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="<?php echo base_url();?>index.php/impress/add"><i class="fa fa-circle-o"></i> 添加印象</a></li>
