        ...
        <section class="content">
                ...
                <div class="form-horizontal" role="form">
                   <div class="form-group">
                      <label for="category_cn" class="col-sm-2 control-label">分类名</label>
                      <div class="col-sm-4">
                        <input type="hidden" class="form-control" id="cat_id" value="<?php echo $item['id']?>"
                            placeholder="">
                         <input type="text" class="form-control" id="category_cn" value="<?php echo $item['category_cn']?>"
                            placeholder="分类名">
                      </div>
                   </div>
                   <div class="form-group">
                      <label for="category_en" class="col-sm-2 control-label">英文别名</label>
                      <div class="col-sm-4">
                         <input type="text" class="form-control" id="category_en" value="<?php echo $item['category_en']?>"
                            placeholder="英文别名">
                      </div>
                   </div>
                   <div class="form-group">
                      ...
                      <div class="col-sm-4">
                         <input type="text" class="form-control" id="description" value="<?php echo $item['description']?>"
                            placeholder="描述">
                      </div>
                   </div>
                   ...
                   <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                         <button type="submit" id="update_category" class="btn btn-default">添加</button>
                      </div>
                   </div>
            </div>
            <?php endforeach;?>
